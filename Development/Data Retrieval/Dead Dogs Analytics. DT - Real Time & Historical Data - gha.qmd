---
title: "Dead Dogs Analytics. Data Retrieval (gha) - DEV"
...
# }
# 
# all_videos_stats_hist <- purrr::map_df(all_video_ids_vector, get_all_videos_hist_info)
```
...
# feather::write_feather("Development/Data Retrieval (DT)/data/dda_playlists_videos_hist_cum_gha.feather")
```
