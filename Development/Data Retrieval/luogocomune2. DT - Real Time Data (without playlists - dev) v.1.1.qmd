...
myapp <- httr::oauth_app("dead-dogs-analytics-yt",
                   key = oauth2_key,
...
api_call_channel_videos_fp <- str_c("https://www.googleapis.com/youtube/v3/playlistItems?playlistId=", uploads, "&key=",google_api_key,"&part=snippet&maxResults=50")
...
get_all_nextPageTokens <- function (nextPageToken) {
  ...
  while (!is.null(nextPageToken)) {
    ...
    api_call_channel_videos_np <- str_c("https://www.googleapis.com/youtube/v3/playlistItems?playlistId=", uploads, "&pageToken=", nextPageToken, "&key=",google_api_key,"&part=snippet,status&maxResults=50")
...
api_call_videos <- str_c("https://www.googleapis.com/youtube/v3/videos?key=",google_api_key,"&id=", video_id, "&part=contentDetails,recordingDetails,snippet,statistics,status,topicDetails,player&maxResults=50")  
...
# api_call_videos <- str_c("https://www.googleapis.com/youtube/v3/videos?key=",google_api_key,"&id=", video_id, "&part=statistics&maxResults=50")

api_call_videos <- str_c("https://www.googleapis.com/youtube/v3/commentThreads?key=",google_api_key,"&videoId=", video_id, "&part=snippet%2Creplies&maxResults=50")
