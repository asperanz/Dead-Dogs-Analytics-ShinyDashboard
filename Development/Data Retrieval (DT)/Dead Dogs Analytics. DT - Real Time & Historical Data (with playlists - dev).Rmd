...
saveRDS(top10_rank, file = here("scripts", "data", "top10_rank.rds"))
```
...
saveRDS(top10_rank_fct, file = here("scripts", "data", "top10_rank_fct.rds"))
```
...
playlists_videos_hist_cum <- playlists_videos_hist %>%
  ...
  saveRDS(file = here("scripts", "data", "playlists_videos_hist_cum.rds"))
```